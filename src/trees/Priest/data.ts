  ...
  Discipline: {
    ...
    talents: {
      ...
      "Holy Nova": {
        ...
        maxRank: 1,
        reqPoints: 10,
        description: talentText`Causes an explosion of holy light around the caster, causing 27 Holy damage to all enemy targets within 10 yards and healing all party members within 10 yards for 50.  These effects cause no threat.`,
      },
      "Mental Agility": {
        name: "Mental Agility",
        pos: "c2",
      ...
      "Searing Light": {
        ...
        maxRank: 3,
        reqPoints: 20,
        description: talentText`Increases the damage done by your Holy Fire and Smite spells by ${[
          2,
          4,
          6,
        ]}%.`,
  ...
  Holy: {
    ...
    talents: {
      ...
      "Spirit of Redemption": {
        ...
        arrows: [{ dir: "down", from: "e2", to: "g2" }],
        description: talentText`o	Transforms you into the Spirit of Redemption, increasing healing done by 10% and decreasing physical damage taken by 10%.  You cannot cast Shadow spells while in this form.`,
      },
    },
  },
  Shadow: {
    ...
    talents: {
      ...
      "Shadowform": {
        ...
        prereq: "Silence",
        arrows: [{ dir: "down", from: "e2", to: "g2" }],
        description: talentText`o	Transforms you into Shadowform, increasing Shadow damage dealt by 10% and decreasing physical damage taken by 10%.  You cannot cast Holy spells while in this form.`,
      },
    },
  },
};
