  ...
  Discipline: {
    ...
    talents: {
      ...
      "Holy Nova": {
        ...
        maxRank: 1,
        reqPoints: 10,
        description: talentText`Causes an explosion of holy light around the caster, causing Holy damage to all enemies within 10 yards and restores health to all party members within 10 yards.  These effects cause no threat.`,
      },
      "Mental Agility": {
        name: "Mental Agility",
        pos: "c2",
