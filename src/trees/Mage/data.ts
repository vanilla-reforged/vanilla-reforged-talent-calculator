  ...
  Arcane: {
    ...
    talents: {
      ...
      "Arcane Burst": {
        ...
        maxRank: 1,
        reqPoints: 20,
        description: talentText`All of your Arcane spell critical strikes grace you with an Arcane Burst, decreasing the casting time of your next Fireball or Frostbolt spell by 0.75 sec.  Lasts 8 sec.  Stacks up to 3 times.`,
      },
      "Magic Absorption": {
      ...
      "Arcane Power": {
        ...
        description: talentText`Increases damage dealt by your spells by 30%, but increases their mana cost by 30%.  Lasts 15 sec.\n\n2 min cooldown.`,
      },
    },
  },
  Fire: {
