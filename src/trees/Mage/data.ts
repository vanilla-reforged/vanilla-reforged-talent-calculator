  ...
  Arcane: {
    ...
    talents: {
      ...
      "Arcane Burst": {
        ...
        maxRank: 1,
        reqPoints: 20,
        description: talentText`All Arcane spell criticals grace you with an Arcane Burst, reducing the casting time of your next spell by 0.5 sec.  Stacks up to 3 times.`,
      },
      "Magic Absorption": {
  ...
  Frost: {
    ...
    talents: {
      ...
      "Frost Bomb": {
        ...
        prereq: "Ice Shards",
        arrows: [{ dir: "down", from: "e2", to: "g2" }],
        description: talentText`Inflicts 276 Frost damage and freezes all targets within the area for 6 sec.  45 sec cooldown`,
      },
    },
  },
};