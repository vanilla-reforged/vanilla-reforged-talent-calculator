  ...
  Arcane: {
    ...
    talents: {
      ...
      "Arcane Burst": {
        ...
        maxRank: 1,
        reqPoints: 20,
        description: talentText`All of your Arcane spell critical strikes grace you with an Arcane Burst, reducing the casting time of your next Fireball or Frostbolt spell by 0.5 sec.  Stacks up to 3 times.`,
      },
      "Magic Absorption": {
  ...
  Fire: {
    ...
    talents: {
      ...
      "Combustion": {
        ...
        prereq: "Blast Wave",
        arrows: [{ dir: "down", from: "e2", to: "g2" }],
        description: talentText`When activated, this spell causes each of your Fire spell hits to improve your chance to get a critical strike with Fire spells by 10% until you have caused 3 critical strikes with Fire spells.\n\n2 min cooldown.`,
      },
    },
  },
  Frost: {
    ...
    talents: {
      ...
      "Sphere of Frost": {
        ...
        prereq: "Ice Shards",
        arrows: [{ dir: "down", from: "e2", to: "g2" }],
        description: talentText`Conjure a Sphere of Frost, dealing 248 Frost damage to all enemies within the area and freezing them for 8 sec.\n\n30 sec cooldown.`,
      },
    },
  },
};