  ...
  Arms: {
    ...
    talents: {
      ...
      "Mortal Strike": {
        ...
        description: talentText`A vicious strike that deals 130% normal weapon damage.  Whenever this ability deals damage, you have a 50% chance for your next Cleave, Hamstring, Heroic Strike, Rend, or Overpower to cost no rage.  Lasts 8 sec.\n\n6 sec cooldown.`,
      },
    },
  },
  Fury: {
  ...
  Protection: {
    ...
    talents: {
      ...
      "Shield Slam": {
        ...
        arrows: [{ dir: "down", from: "e2", to: "g2" }],
        description: talentText`Slam the target with your shield, causing 224 damage, modified by your shield block value, and dispelling 1 magic effect on the target.  Also causes a high amount of threat.\n\n6 sec cooldown.`,
      },
    },
  },
};
