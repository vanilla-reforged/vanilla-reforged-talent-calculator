  ...
  Enhancement: {
    ...
    talents: {
      ...
      "Stormstrike": {
        ...
        arrows: [{ dir: "down", from: "e2", to: "g2" }],
        description: talentText`Attack the enemy with your weapon. In addition your abilities that deal Nature damage, deal 10% more damage for 10 sec. (10 sec cooldown)`,
      },
    },
  },
  Restoration: {
