  ...
  Enhancement: {
    ...
    talents: {
      ...
      "Stormstrike": {
        ...
        arrows: [{ dir: "down", from: "e2", to: "g2" }],
        description: talentText`Attack the enemy with your weapon and grant the members of your party a 4% increase to all damage dealt for 10 sec. (10 sec cooldown)`,
      },
    },
  },
  Restoration: {
