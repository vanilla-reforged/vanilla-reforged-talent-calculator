  ...
  Protection: {
    ...
    talents: {
      ...
      "Holy Shield": {
        ...
        arrows: [{ dir: "down", from: "e2", to: "g2" }],
        description: talentText`Increases your chance to block by 30% for 10 sec, and deals 65 Holy damage for each attack blocked while active.  In Addition each Block generates 1% of your total mana.  Damage caused by Holy Shield causes 20% additional threat.  Each block expends a charge.  4 charges.  10 sec cooldown`,
      },
    },
  },
  Retribution: {
