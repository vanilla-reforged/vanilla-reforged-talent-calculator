  ...
  Protection: {
    ...
    talents: {
      ...
      "Holy Shield": {
        ...
        arrows: [{ dir: "down", from: "e2", to: "g2" }],
        description: talentText`Generates 5% of your total mana.  Increases chance to block by 30% for 10 sec, and deals 65 Holy damage for each attack blocked while active.  Damage caused by Holy Shield causes 20% additional threat.  Each block expends a charge.  4 charges.  10 sec cooldown`,
      },
    },
  },
  Retribution: {
    ...
    talents: {
      ...
      "Crusader Strike": {
        ...
        prereq: "Repentance",
        arrows: [{ dir: "down", from: "e2", to: "g2" }],
        description: talentText`A vicious strike that deals 135% weapon damage and generates 5% of your total mana.  10 sec cooldown`,
      },
    },
  },
};
