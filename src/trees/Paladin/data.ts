  ...
  Protection: {
    ...
    talents: {
      ...
      "Improved Righteous Fury": {
        ...
        maxRank: 5,
        reqPoints: 0,
        description: talentText`Increases the amount of threat generated by your Righteous Fury spell by an additional ${[
          5,
          10,
          15,
          20,
      ...
      "Sanctuary": {
        ...
        maxRank: 1,
        reqPoints: 10,
        description: talentText`Places a Holy Blessing on you, reducing damage received from all sources by up to 10 for 30 min.  In addition, when you block a melee attack the attacker will take 14 Holy damage.`,
      },
      "Redoubt": {
        name: "Redoubt",
        pos: "c2",
      ...
      "Templar's Blow": {
        ...
        maxRank: 1,
        reqPoints: 20,
        description: talentText`Requires One Handed Weapon.  An instant attack that deals holy damage equal to 120% of weapon damage.\n\n10 sec cooldown.`,
      },
      "Force of Faith": {
        name: "Force of Faith",
        pos: "e3",
      ...
      "Holy Shield": {
        ...
        arrows: [{ dir: "down", from: "e2", to: "g2" }],
        description: talentText`Increases your chance to block by 60% for 14 sec and generates 3% of your total Mana.  While active 65 Holy damage are dealt to an attacker when his attack is blocked.  Damage caused by Holy Shield causes 20% additional threat.  Each block expends a charge.  4 charges.\n\n10 sec cooldown.`,
      },
    },
  },
  Retribution: {
    ...
    talents: {
      ...
      "Crusader Strike": {
        ...
        prereq: "Repentance",
        arrows: [{ dir: "down", from: "e2", to: "g2" }],
        description: talentText`Requires Two Handed Weapon.  Gives you an extra attack and generates 3% of your total mana.  In addition, the next 2 sources of Holy damage dealt to the target are increased by 20%.  Lasts 12 sec.\n\n10 sec cooldown.`,
      },
    },
  },
};
