  ...
  Marksmanship: {
    ...
    talents: {
      ...
      "Aimed Shot": {
        ...
        prereq: "Scatter Shot",
        arrows: [{ dir: "down", from: "e2", to: "g2" }],
        description: talentText`An aimed shot that deals 140% normal ranged weapon damage.  6 sec cooldown`,
      },
    },
  },
  Survival: {
